...
import type { ProjectInventory, ProjectIssue, ProjectInputView } from '../subs/project/src/interfaces/project.js';
...
function projectDiagnostics(inventory: ProjectInventory | null, issues: readonly ProjectIssue[], parsed: ReadonlyMap<string, ParsedDescription>): AnalysisDiagnostic[] {
  ...
  for (const issue of issues) {
    ...
    result.push(diagnostic(issue.code, issue.message, references.length ? 'description' : 'acquisition',
