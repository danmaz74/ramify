 ...
 */
export const example2Declaration: ModelInput = defineDiagramModel({
  name: 'app',
  children: [
    {
      name: 'pricing',
      ...
      symbols: [{ name: 'PriceModel', destinations: ['parent', 'descendants'] }],
      children: [{ name: 'discounts' }, { name: 'taxes' }],
    },
    {
      name: 'checkout',
      symbols: [{ name: 'submitOrder', destinations: ['parent'] }],
    },
  ],
});
