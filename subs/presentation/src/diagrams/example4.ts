 ...
 */
export const example4Declaration: ModelInput = defineDiagramModel({
  name: 'app',
  relays: [
    { name: 'formatMoney', child: 'shared', destinations: ['descendants'] },
    { name: 'queryDb', child: 'shared', destinations: ['descendants'] },
  ],
  children: [
    {
      name: 'shared',
      ...
      symbols: [
        { name: 'formatMoney', destinations: ['parent'], tags: ['browser'] },
        { name: 'queryDb', destinations: ['parent'] },
      ],
    },
    { name: 'ui', tags: ['browser'] },
    { name: 'server' },
  ],
});
