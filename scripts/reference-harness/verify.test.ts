...
describe('reference verification invocation', () => {
  ...
  it.each([undefined, 3, 4, 5])('reports actual model/parser/acquisition execution and pending source work for iteration %s', (iteration) => {
    ...
    const passed = iteration === 3 ? 14 : iteration === 4 ? 53 : iteration === 5 ? 88 : 102;
